        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/50">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2 font-medium">
              Start your 30-day AI mastery journey
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                <Briefcase className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-blue-500 transition-colors z-10" />
                <select
                  value={formData.specialty}
                  onChange={(e) => setFormData({ ...formData, specialty: e.target.value })}
                  className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10 transition-all duration-200 outline-none appearance-none cursor-pointer"
                  required
                >
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 pt-6 border-t border-gray-100">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-600 font-medium">AI Confidence</p>
            </div>
          </div>
        </div>
      </div>
